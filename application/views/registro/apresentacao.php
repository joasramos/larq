...
<style>
    .titulo{
        ...
        font-weight:bold;
        font-size: 29px;
        text-shadow:0px 0px 0 rgb(-40,-5,64),
            1px 1px 0 rgb(-84,-49,20), 
            2px 2px 0 rgb(-127,-92,-23),
...
<h3 style="margin: 20px; text-align: center" class="titulo"> I SEMINÁRIO DO LABORATÓRIO DE ARQUEOLOGIA DA UFMA</h3>
<div id='wrap'>
        ...
        <p class="apre">
         ...
         <div style="height: 300px ; margin-top: 5em;
            ...
            <div style='background-color: black; opacity: 0.5; color: white; font-size: 12px; width: 450px'>
                <p style='padding: 5px'> Definição: Estearia do Coqueiro  |  Local: Olinda Nova - MA  |  Foto: Alexandre Navarro</p>
            </div>
