...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Ago-2014 às 03:58
...
INSERT INTO `formacao` (`idform`, `nome`) VALUES
(1, 'Pós-Graduação'),
(2, 'Graduação'),
(3, 'Ensino Médio');
...
CREATE TABLE IF NOT EXISTS `participante` (
  ...
  `inscricao_paga` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `participante` (`idparti`, `nome`, `email`, `telefone`, `instituicao`, `formacao`, `user`, `pass`, `inscricao_paga`, `admin`) VALUES
(4, 'Administrador LARQ', 'joasramos@uol.com.br', '', '', 0, 'admin', '63caf147d897b3c51997101be37877da', 0, 1),
(27, 'Joas Ramos Araujo', 'sirjoasramosaraujo@gmail.com', '9832370071', 'UFMA', 1, 'joasramos', '71a6d27a0a4a3ac806dc38aedb03fbe4', 1, 0),
(28, 'Dona Florinda', 'dona@gmail.com', '9832370071', 'UFMA', 2, 'dona-florinda', '71a6d27a0a4a3ac806dc38aedb03fbe4', 1, 0),
(29, 'Joas Ramos Araujo', 'sirjoasramosaraujo@gmail.com', '9832370071', 'UFMA', 3, 'joasramos', '42ded1279433b24eaef9c4c613846c3b', 0, 0);
...
(1, 'joasramos', '9a618248b64db62d15b300a07b00580b');
...
--
-- Limitadores para a tabela `idartefato`
--
